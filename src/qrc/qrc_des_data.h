...
static constexpr std::array<uint8_t, 16> key_rnd_shift = {
    1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1,
};

static constexpr std::array<std::array<uint8_t, 64>, 8> g_sboxes = {{
...
static constexpr auto kIpTable = ([] {
    std::array<uint8_t, 64> data = {58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20, 12, 4,
...
static constexpr auto kIpInvTable = ([] {
    std::array<uint8_t, 64> data = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31,
...
static constexpr auto key_perm_d = ([] {
    std::array<uint8_t, 28> data = {63, 55, 47, 39, 31, 23, 15, 7,  62, 54, 46, 38, 30, 22,
